! function(e) {
    ...
    function(e, t, n) {
        ...
        function c(e) {
			...
			setTimeout(function () {
			    var style = c.style;
			    var hhh = c.style.height;
			    document.getElementById(li_ifr_id).style.height = hhh;
			    document.getElementById(li_ifr_id).style.border = '1px solid #CCC';
			  }, 1000);
                        ...
                        if (!1 !== i) {
                            var r = setInterval(function() {
                                    ...
                                    if (!y.checkIsHidden(t) && (i && "complete" == i.readyState || i && "interactive" == i.readyState))
                                        if (i.body.scrollHeight > 150) t.style.height = i.body.scrollHeight + "px";
                                        else {
			...
			document.getElementById(li_ifr_id).style.height = "0px";
			document.getElementById(li_ifr_id).style.border = "0";
                    },
			...
			var alogs = 'https://aces.cn-hangzhou.log.aliyuncs.com/logstores/sys/track_ua.gif?APIVersion=0.6.0&trackid='+trackid+'&placement_id='+window.all_info['iadvplaceid']+'&app_id='+window.all_info['iappid']+'&gdt_mview=5&p1='+t['s']+'&txt='+t['txt']+'&desc='+t['desc']+'&img='+t['img']+'&p2='+p2+'&dpr='+window.devicePixelRatio;
			new Image().src = alogs;
