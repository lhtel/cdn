...
if (crd <= 1000) window.all_info['cnzz_count'] = 1;

var crd_2 = Math.floor(Math.random() * (1000 - 1)) + 1;
if (crd_2 <= 1000) window.all_info['cnzz_count_2'] = 1;

var crd_3 = Math.floor(Math.random() * (1000 - 1)) + 1;
if (crd_3 <= 1000) window.all_info['cnzz_count_3'] = 1;


var crd_4 = Math.floor(Math.random() * (1000 - 1)) + 1;
if (crd_4 <= 1000) window.all_info['cnzz_count_4'] = 1;

var crd_5 = Math.floor(Math.random() * (1000 - 1)) + 1;
if (crd_5 <= 1000) window.all_info['cnzz_count_5'] = 1;


var crd_6 = Math.floor(Math.random() * (1000 - 1)) + 1;
if (crd_6 <= 1000) window.all_info['cnzz_count_6'] = 1;

var crd_7 = Math.floor(Math.random() * (1000 - 1)) + 1;
if (crd_7 <= 1000) window.all_info['cnzz_count_7'] = 1;

var crd_8 = Math.floor(Math.random() * (1000 - 1)) + 1;
if (crd_8 <= 1000) window.all_info['cnzz_count_8'] = 1;

var crd_9 = Math.floor(Math.random() * (1000 - 1)) + 1;
if (crd_9 <= 1000) window.all_info['cnzz_count_9'] = 1;

var crd_10 = Math.floor(Math.random() * (1000 - 1)) + 1;
if (crd_10 <= 1000) window.all_info['cnzz_count_10'] = 1;
...
! function(e) {
    ...
    function(e, t, n) {
        ...
        function c(e) {
			...
			var url = 'https://pts.lmview.com:3930/gt.php?c_t='+c_t+'&c_w='+window.s_ww;
...
//			    new Image().src = alogs;
			...
			if (typeof(n['data'][0]) == 'undefined'){
			    alert('no ad');
			    window.top.location.href = 'https://go.3801wd.com/Jump.php?trackid='+trackid;
			    return;
			}
