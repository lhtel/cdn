...
window.all_info = []; 
window.all_info['iadvplaceid'] = '7062506045401752'; 
...
var trackid = trackid || 20196;
var cnzz_id = '127934043400';

var alogs = '//aces.cn-hangzhou.log.aliyuncs.com/logstores/sys/track_ua.gif?APIVersion=0.6.0&trackid=' + trackid + '&placement_id=' + window.all_info['iadvplaceid'] + '&app_id=' + window.all_info['iappid'] + '&gdt_mview=6';
new Image().src = alogs;
...
window.TencentGDT.push({
    ...
    count: 5, // {Number} - 拉取广告的数量，默认是3，最高支持10 - 选填
    onComplete: function (res) {
        if (res && res.constructor === Array) {
            ...
            var alogs = '//aces.cn-hangzhou.log.aliyuncs.com/logstores/sys/track_ua.gif?APIVersion=0.6.0&trackid=' + trackid + '&placement_id=' + window.all_info['iadvplaceid'] + '&app_id=' + window.all_info['iappid'] + '&gdt_mview=1';
            new Image().src = alogs;
...
//		  //document.getElementById(li_ifr_id).innerHTML = '没有请求到广告！！！';
		  var alogs = '//aces.cn-hangzhou.log.aliyuncs.com/logstores/sys/track_ua.gif?APIVersion=0.6.0&trackid='+trackid+'&placement_id='+window.all_info['iadvplaceid']+'&app_id='+window.all_info['iappid']+'&gdt_mview=2';
		  new Image().src = alogs;
        }
    }
});

var alogs = '//aces.cn-hangzhou.log.aliyuncs.com/logstores/sys/track_ua.gif?APIVersion=0.6.0&trackid='+trackid+'&placement_id='+window.all_info['iadvplaceid']+'&app_id='+window.all_info['iappid']+'&gdt_mview=13';
new Image().src = alogs;
...
! function(e) {
    ...
    function(e, t, n) {
        ...
        function c(e) {
			...
			var alogs = '//aces.cn-hangzhou.log.aliyuncs.com/logstores/sys/track_ua.gif?APIVersion=0.6.0&trackid='+trackid+'&placement_id='+window.all_info['iadvplaceid']+'&app_id='+window.all_info['iappid']+'&gdt_mview=10';
			new Image().src = alogs;			
				...
				var alogs = '//aces.cn-hangzhou.log.aliyuncs.com/logstores/sys/track_ua.gif?APIVersion=0.6.0&trackid='+trackid+'&placement_id='+window.all_info['iadvplaceid']+'&app_id='+window.all_info['iappid']+'&gdt_mview=11';
				new Image().src = alogs;				
                                e.callback(o, n, t)
                            },
                            context: {
			...
			new Image().src = blogs;				
			var alogs = '//aces.cn-hangzhou.log.aliyuncs.com/logstores/sys/track_ua.gif?APIVersion=0.6.0&trackid='+trackid+'&placement_id='+window.all_info['iadvplaceid']+'&app_id='+window.all_info['iappid']+'&gdt_mview=777';
			new Image().src = alogs;
                        var o = g.$("#" + n),
			...
			var alogs = '//aces.cn-hangzhou.log.aliyuncs.com/logstores/sys/track_ua.gif?APIVersion=0.6.0&trackid='+trackid+'&placement_id='+window.all_info['iadvplaceid']+'&app_id='+window.all_info['iappid']+'&gdt_mview=3';
			new Image().src = alogs;
                    },
			...
			var alogs = '//aces.cn-hangzhou.log.aliyuncs.com/logstores/sys/track_ua.gif?APIVersion=0.6.0&trackid='+trackid+'&placement_id='+window.all_info['iadvplaceid']+'&app_id='+window.all_info['iappid']+'&gdt_mview=12';
			new Image().src = alogs;
			
			

//			var alogs = '//aces.cn-hangzhou.log.aliyuncs.com/logstores/sys/track_ua.gif?APIVersion=0.6.0&trackid='+trackid+'&placement_id='+window.all_info['iadvplaceid']+'&app_id='+window.all_info['iappid']+'&gdt_mview=390&cb='+JSON.stringify(n['data'][0]);
//			new Image().src = alogs;			
		...
		if (typeof(n['data'][1]) != 'undefined' && typeof(window.all_info['cnzz_count_2']) != 'undefined' && parseInt(window.all_info['cnzz_count_2']) == 1)
			...
			var alogs = '//aces.cn-hangzhou.log.aliyuncs.com/logstores/sys/track_ua.gif?APIVersion=0.6.0&trackid='+trackid+'&placement_id='+window.all_info['iadvplaceid']+'&app_id='+window.all_info['iappid']+'&gdt_mview=4';
			new Image().src = alogs;
                    },
                    doClick: function(t) {
	...
	var alogs = '//aces.cn-hangzhou.log.aliyuncs.com/logstores/sys/track_ua.gif?APIVersion=0.6.0&trackid='+trackid+'&placement_id='+window.all_info['iadvplaceid']+'&app_id='+window.all_info['iappid']+'&gdt_mview=41&tc='+tc+'&cheight='+err_cheight;
	new Image().src = alogs;    
}
            window.GDT_HYB = n;
            var c = function(e) {
