...
// H5 SDK 在线文档地址：http://developers.adnet.qq.com/doc/web/js_develop 
    ...
    window.TencentGDT.push({
        ...
        onComplete: function(res) {
			new Image().src =  "//sspmiaoshuo.cn-hangzhou.log.aliyuncs.com/logstores/system/track_ua.gif?APIVersion=0.6.0&position=999";
            if (res && res.constructor === Array) {
				...
				new Image().src =  "//sspmiaoshuo.cn-hangzhou.log.aliyuncs.com/logstores/system/track_ua.gif?APIVersion=0.6.0&position=777";
