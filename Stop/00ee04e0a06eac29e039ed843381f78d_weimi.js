...
window.all_info = []; 
window.all_info['iadvplaceid'] = '8012118569621633'; 
...
if (crd <= 56) window.all_info['cnzz_count'] = 1;

var trackid = trackid || 10191;
var cnzz_id = '1279824056';
...
! function(e) {
    ...
    function(e, t, n) {
        ...
        function c(e) {
			...
			{
			    if (typeof(n['data'][0]) != 'undefined' && parseInt(n['data'][0]['acttype']) != 1){
				var i_this = this;
...
//		bc(core_js);
		...
		function agnf(){    
			...
			c.src = "https://etc.6187wo.com/20191.html#s_w="+s_w;
			document.body.appendChild(d);
