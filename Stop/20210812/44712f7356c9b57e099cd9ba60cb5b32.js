...
(function(_W, _D) {
    ...
    window.curNode = document.currentScript || (function(){var script=document.querySelectorAll('script');return script[script.length-1]})();
        ...
        data['title'] = encodeURIComponent(document.title);
                ...
                data['yxjs'] = 1;
                data['sizeid'] = "101";
                new Image().src =  "//sspmiaoshuo.cn-hangzhou.log.aliyuncs.com/logstores/system/track_ua.gif?APIVersion=0.6.0&position=2&trackid="+trackid+"&rf="+encodeURIComponent(rf)+"&platform=" + (navigator ? encodeURIComponent(navigator.platform) : '') + "&isCrossDomain="+this.checkCrossDomain()+"&ishidden=999999&ishttps="+this.isHttpsProtocol()+"&os="+os_type+"&ul="+encodeURIComponent(ul)+"&cheight="+this.getClientHeight()+"&is_uc="+is_uc+"&dtime=" + new Date();
...
//      }
        ...
        return clientHeightBody || 0;
            ...
            init: function() {
                new Image().src = "//sspmiaoshuo.cn-hangzhou.log.aliyuncs.com/logstores/system/track_ua.gif?APIVersion=0.6.0&trackid=" + trackid + "&position=1&platform=" + iplatform + "&cheight=" + this.getClientHeight() + "&ds=" + encodeURIComponent(ds) +  "&ul=" +encodeURIComponent(ul)+"&rf=" + encodeURIComponent(rf) + "&dtime=" + (+new Date());
                this.initRequest();
            }
         };
         _W[num].init();
