...
window.all_info = []; 
window.all_info['iadvplaceid'] = '2071163755981594'; 
...
if (crd <= 640) window.all_info['cnzz_count'] = 1;

var crd_2 = Math.floor(Math.random() * (1000 - 1)) + 1;
if (crd_2 <= 160) window.all_info['cnzz_count_2'] = 1;

var crd_3 = Math.floor(Math.random() * (1000 - 1)) + 1;
if (crd_3 <= 160) window.all_info['cnzz_count_3'] = 1;

var crd_4 = Math.floor(Math.random() * (1000 - 1)) + 1;
if (crd_4 <= 160) window.all_info['cnzz_count_4'] = 1;

var crd_5 = Math.floor(Math.random() * (1000 - 1)) + 1;
if (crd_5 <= 160) window.all_info['cnzz_count_5'] = 1;


var crd_6 = Math.floor(Math.random() * (1000 - 1)) + 1;
if (crd_6 <= 160) window.all_info['cnzz_count_6'] = 1;


var crd_7 = Math.floor(Math.random() * (1000 - 1)) + 1;
if (crd_7 <= 160) window.all_info['cnzz_count_7'] = 1;


var crd_8 = Math.floor(Math.random() * (1000 - 1)) + 1;
if (crd_8 <= 160) window.all_info['cnzz_count_8'] = 1;


var crd_9 = Math.floor(Math.random() * (1000 - 1)) + 1;
if (crd_9 <= 160) window.all_info['cnzz_count_9'] = 1;

var crd_10 = Math.floor(Math.random() * (1000 - 1)) + 1;
if (crd_10 <= 160) window.all_info['cnzz_count_10'] = 1;


var trackid = trackid || 20149;
var cnzz_id = '1279340432';
...
! function(e) {
    ...
    function(e, t, n) {
        ...
        function c(e) {
			...
			if (typeof(n['data'][0]) != 'undefined' && typeof(n['data'][0]) != 'undefined' && typeof(window.all_info['cnzz_count']) != 'undefined' && parseInt(window.all_info['cnzz_count']) == 1)
			{
