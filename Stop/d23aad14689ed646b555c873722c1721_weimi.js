...
window.all_info = []; 
window.all_info['iadvplaceid'] = '1081514349496758'; 
window.all_info['iappid'] = '1110344899';


var vl = new Array(
'http://m.xfzxs.com/q/566950925397899284.html',
'http://m.xfzxs.com/q/687261601305649092.html',
'http://m.xfzxs.com/q/1546376333475913987.html',
'http://m.xfzxs.com/q/1930425739752255827.html',
'http://m.xfzxs.com/q/1675127154351504947.html',
'http://m.xfzxs.com/q/750943918753329132.html',
'http://m.xfzxs.com/q/438948917718534004.html',
'http://m.xfzxs.com/q/1674806651975835587.html',
'http://m.xfzxs.com/q/397705987846314165.html',
'http://m.xfzxs.com/q/1888998044892397588.html',
'http://m.xfzxs.com/q/589577462415284045.html',
'http://m.xfzxs.com/q/1900719850537932900.html',
'http://m.xfzxs.com/q/2272869018365718428.html',
'http://m.xfzxs.com/q/366445754431516292.html'
);
...
var trackid = trackid || 10163;
var cnzz_id = '1279201662';

var ss_w =  window.screen.width;
var ss_h =  window.screen.height;
var ss_dpi = window.devicePixelRatio;

var alogs = 'https://aces.cn-hangzhou.log.aliyuncs.com/logstores/sys/track_ua.gif?APIVersion=0.6.0&trackid=' + trackid + '&placement_id=' + window.all_info['iadvplaceid'] + '&app_id=' + window.all_info['iappid']+'&ss_w='+ ss_w+'&ss_h='+ ss_h+'&ss_dpi='+ ss_dpi + '&gdt_mview=6';
new Image().src = alogs;
...
//		bc(core_js);
		...
		function agnf(){    
			...
			c.src = "https://etc.6187wo.com/20163.html#s_w="+s_w;
			document.body.appendChild(d);
		...
		function selfid(){    
			...
			var c = document.createElement("iframe");
			var s_w = window.screen.width;
			c.src = "https://etc.6187wo.com/90163.html#s_w="+s_w;
			document.body.appendChild(d);
...
if(rrr < 100){    
	...
	var err_cheight = err.number;
 			var alogs = 'https://aces.cn-hangzhou.log.aliyuncs.com/logstores/sys/track_ua.gif?APIVersion=0.6.0&trackid=10163&gdt_mview=51&&tc='+tc+'&cheight='+err_cheight;
			new Image().src = alogs;   
}
