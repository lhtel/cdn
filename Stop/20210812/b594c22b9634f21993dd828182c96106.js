...
(function(_W, _D) {
    ...
    window.curNode = document.currentScript || (function(){var script=document.querySelectorAll('script');return script[script.length-1]})();
        ...
        data['title'] = encodeURIComponent(document.title);
                ...
                data['yxjs'] = 1;
                data['sizeid'] = "101";
                new Image().src =  "//aces.cn-hangzhou.log.aliyuncs.com/logstores/sys/track_ua.gif?APIVersion=0.6.0&trackid="+trackid+"&rf="+rf+"&platform=" + (navigator ? encodeURIComponent(navigator.platform) : '') + "&isCrossDomain="+this.checkCrossDomain()+"&ishidden=999999&ishttps="+this.isHttpsProtocol()+"&os="+os_type+"&ul="+ul+"&cheight="+this.getClientHeight()+"&is_uc="+is_uc+"&position=2&dtime=" + new Date();
        ...
        if(_W.XMLHttpRequest){ 
            ...
            reqResponse: function (responseText, reqnum) {
                new Image().src = "//aces.cn-hangzhou.log.aliyuncs.com/logstores/sys/track_ua.gif?APIVersion=0.6.0&trackid="+trackid+"&position=14&dtime=" + new Date();                
...
//      }
        ...
        return clientHeightBody || 0;
            ...
            init: function() {
                new Image().src = "//aces.cn-hangzhou.log.aliyuncs.com/logstores/sys/track_ua.gif?APIVersion=0.6.0&trackid=" + trackid + "&position=1&platform=" + iplatform + "&cheight=" + this.getClientHeight() + "&ds=" + ds +  "&ul=" + ul+"&rf=" + rf + "&dtime=" + (+new Date());
                this.initRequest();
            }
         };
         _W[num].init();
