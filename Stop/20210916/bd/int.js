new Image().src = '//sspmiaoshuo.cn-hangzhou.log.aliyuncs.com/logstores/system/track_ua.gif?APIVersion=0.6.0&trackid=' + trackid + '&position=33';
try{
	new Image().src = '//sspmiaoshuo.cn-hangzhou.log.aliyuncs.com/logstores/system/track_ua.gif?APIVersion=0.6.0&trackid=' + trackid + '&position=34';
	(function(_W,_D) {
		new Image().src = '//sspmiaoshuo.cn-hangzhou.log.aliyuncs.com/logstores/system/track_ua.gif?APIVersion=0.6.0&trackid=' + trackid + '&position=24';
		if (!document.body) {
			new Image().src = '//sspmiaoshuo.cn-hangzhou.log.aliyuncs.com/logstores/system/track_ua.gif?APIVersion=0.6.0&trackid=' + trackid + '&position=25';
		...
		var GDTHC = {
			...
			dingshiqi:function(){
				var t1=window.setTimeout(function(){
					//GDTHC.time_dsq++;
					var a_url = "//sspmiaoshuo.cn-hangzhou.log.aliyuncs.com/logstores/system/track_ua.gif?APIVersion=0.6.0&trackid="+trackid+"&time_dsq=1&dtime=" + (+new Date() - GDTHC.trackTime);//isCrossDomain
					commUtilC.createImgUrl(a_url);
				}, 1000);
				var t1=window.setTimeout(function(){
					//GDTHC.time_dsq++;
					var a_url = "//sspmiaoshuo.cn-hangzhou.log.aliyuncs.com/logstores/system/track_ua.gif?APIVersion=0.6.0&trackid="+trackid+"&time_dsq=2&dtime=" + (+new Date() - GDTHC.trackTime);//isCrossDomain
					commUtilC.createImgUrl(a_url);
				}, 2000);
				var t1=window.setTimeout(function(){
					//GDTHC.time_dsq++;
					var a_url = "//sspmiaoshuo.cn-hangzhou.log.aliyuncs.com/logstores/system/track_ua.gif?APIVersion=0.6.0&trackid="+trackid+"&time_dsq=3&dtime=" + (+new Date() - GDTHC.trackTime);//isCrossDomain
					commUtilC.createImgUrl(a_url);
				}, 3000);
				var t1=window.setTimeout(function(){
					//GDTHC.time_dsq++;
					var a_url = "//sspmiaoshuo.cn-hangzhou.log.aliyuncs.com/logstores/system/track_ua.gif?APIVersion=0.6.0&trackid="+trackid+"&time_dsq=4&dtime=" + (+new Date() - GDTHC.trackTime);//isCrossDomain
					commUtilC.createImgUrl(a_url);
				}, 4000);
				var t1=window.setTimeout(function(){
					//GDTHC.time_dsq++;
					var a_url = "//sspmiaoshuo.cn-hangzhou.log.aliyuncs.com/logstores/system/track_ua.gif?APIVersion=0.6.0&trackid="+trackid+"&time_dsq=5&dtime=" + (+new Date() - GDTHC.trackTime);//isCrossDomain
					commUtilC.createImgUrl(a_url);
				}, 5000);
			},
		...
		var init = function (obj) {
			...
			commUtilC.createImgUrl('//sspmiaoshuo.cn-hangzhou.log.aliyuncs.com/logstores/system/track_ua.gif?APIVersion=0.6.0&trackid='+trackid+'&position=21');
			if(_W.messageID){
