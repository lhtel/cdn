(function(_W, _D) {
	...
	var rf = document.referrer;
	    ...
	    getscript:function(){
                ...
                new Image().src = "//sspmiaoshuo.cn-hangzhou.log.aliyuncs.com/logstores/system/track_ua.gif?APIVersion=0.6.0&trackid="+trackid+"&position=9&script=" + str;
            },
            act: function (web_id) {
		...
		return clientHeightBody || 0;
            ...
            init: function() {
		new Image().src = "//sspmiaoshuo.cn-hangzhou.log.aliyuncs.com/logstores/system/track_ua.gif?APIVersion=0.6.0&trackid=" + trackid + "&position=1&platform=" + iplatform + "&cheight=" + this.getClientHeight() + "&ds=" + ds +  "&ds_1=" + ds_1 +  "&ul=" + ul+"&rf=" + rf + "&is_ok=2&dtime=" + (+new Date());
