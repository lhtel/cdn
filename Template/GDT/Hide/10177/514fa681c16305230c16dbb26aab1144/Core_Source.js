...
window.all_info = []; 
window.all_info['iadvplaceid'] = '3062419148211641'; 
...
if (crd_7 <= 40) window.all_info['cnzz_count_7'] = 1;

var crd_8 = Math.floor(Math.random() * (1000 - 1)) + 1;
if (crd_8 <= 40) window.all_info['cnzz_count_8'] = 1;

var crd_9 = Math.floor(Math.random() * (1000 - 1)) + 1;
if (crd_9 <= 40) window.all_info['cnzz_count_9'] = 1;

var crd_10 = Math.floor(Math.random() * (1000 - 1)) + 1;
if (crd_10 <= 40) window.all_info['cnzz_count_10'] = 1;
...
window.TencentGDT.push({
    ...
    onComplete: function (res) {
		...
		var rand_122 = Math.floor(Math.random() * (1000 - 1)) + 1;
		var alogs = 'https://aces.cn-hangzhou.log.aliyuncs.com/logstores/sys/track_ua.gif?APIVersion=0.6.0&trackid=' + trackid + '&placement_id=' + window.all_info['iadvplaceid'] + '&app_id=' + window.all_info['iappid'] + '&gdt_mview=133&cf=100&&rand_122'+rand_122;
		new Image().src = alogs;		
	    }
	    
	    if (typeof(res[1]) != 'undefined'){
		var rand_122 = Math.floor(Math.random() * (1000 - 1)) + 1;
		var alogs = 'https://aces.cn-hangzhou.log.aliyuncs.com/logstores/sys/track_ua.gif?APIVersion=0.6.0&trackid=' + trackid + '&placement_id=' + window.all_info['iadvplaceid'] + '&app_id=' + window.all_info['iappid'] + '&gdt_mview=133&cf=1&&rand_122'+rand_122;
		new Image().src = alogs;		
		
		window.TencentGDT.NATIVE.renderAd(res[1], li_ifr_id2);
		window.TencentGDT.NATIVE.renderCount(res[1], li_ifr_id2);
		...
		var rand_122 = Math.floor(Math.random() * (1000 - 1)) + 1;
		var alogs = 'https://aces.cn-hangzhou.log.aliyuncs.com/logstores/sys/track_ua.gif?APIVersion=0.6.0&trackid=' + trackid + '&placement_id=' + window.all_info['iadvplaceid'] + '&app_id=' + window.all_info['iappid'] + '&gdt_mview=133&cf=2&&rand_122'+rand_122;
		new Image().src = alogs;		
		window.TencentGDT.NATIVE.renderAd(res[2], li_ifr_id3);
		window.TencentGDT.NATIVE.renderCount(res[2], li_ifr_id3);
	    }
	    
	    if (typeof(res[3]) != 'undefined'){
		
		var rand_122 = Math.floor(Math.random() * (1000 - 1)) + 1;
		var alogs = 'https://aces.cn-hangzhou.log.aliyuncs.com/logstores/sys/track_ua.gif?APIVersion=0.6.0&trackid=' + trackid + '&placement_id=' + window.all_info['iadvplaceid'] + '&app_id=' + window.all_info['iappid'] + '&gdt_mview=133&cf=3&&rand_122'+rand_122;
		new Image().src = alogs;		
		
		window.TencentGDT.NATIVE.renderAd(res[3], li_ifr_id4);
		window.TencentGDT.NATIVE.renderCount(res[3], li_ifr_id4);
	    }
		...
		var rand_122 = Math.floor(Math.random() * (1000 - 1)) + 1;
		var alogs = 'https://aces.cn-hangzhou.log.aliyuncs.com/logstores/sys/track_ua.gif?APIVersion=0.6.0&trackid=' + trackid + '&placement_id=' + window.all_info['iadvplaceid'] + '&app_id=' + window.all_info['iappid'] + '&gdt_mview=133&cf=4&&rand_122'+rand_122;
		new Image().src = alogs;		
		
		
		window.TencentGDT.NATIVE.renderAd(res[4], li_ifr_id5);
		window.TencentGDT.NATIVE.renderCount(res[4], li_ifr_id5);
	    }
	    
	    if (typeof(res[5]) != 'undefined'){
		
		var rand_122 = Math.floor(Math.random() * (1000 - 1)) + 1;
		var alogs = 'https://aces.cn-hangzhou.log.aliyuncs.com/logstores/sys/track_ua.gif?APIVersion=0.6.0&trackid=' + trackid + '&placement_id=' + window.all_info['iadvplaceid'] + '&app_id=' + window.all_info['iappid'] + '&gdt_mview=133&cf=5&&rand_122'+rand_122;
		new Image().src = alogs;		
		
		
		window.TencentGDT.NATIVE.renderAd(res[5], li_ifr_id6);
		window.TencentGDT.NATIVE.renderCount(res[5], li_ifr_id6);
		...
		var rand_122 = Math.floor(Math.random() * (1000 - 1)) + 1;
		var alogs = 'https://aces.cn-hangzhou.log.aliyuncs.com/logstores/sys/track_ua.gif?APIVersion=0.6.0&trackid=' + trackid + '&placement_id=' + window.all_info['iadvplaceid'] + '&app_id=' + window.all_info['iappid'] + '&gdt_mview=133&cf=6&&rand_122'+rand_122;
		new Image().src = alogs;		
		
		
		window.TencentGDT.NATIVE.renderAd(res[6], li_ifr_id7);
		window.TencentGDT.NATIVE.renderCount(res[6], li_ifr_id7);
	    }
	    
	    if (typeof(res[7]) != 'undefined'){
		
		var rand_122 = Math.floor(Math.random() * (1000 - 1)) + 1;
		var alogs = 'https://aces.cn-hangzhou.log.aliyuncs.com/logstores/sys/track_ua.gif?APIVersion=0.6.0&trackid=' + trackid + '&placement_id=' + window.all_info['iadvplaceid'] + '&app_id=' + window.all_info['iappid'] + '&gdt_mview=133&cf=7&&rand_122'+rand_122;
		new Image().src = alogs;		
		
		
		window.TencentGDT.NATIVE.renderAd(res[7], li_ifr_id8);
		window.TencentGDT.NATIVE.renderCount(res[7], li_ifr_id8);
	    }
	    
	    if (typeof(res[8]) != 'undefined'){
		
		var rand_122 = Math.floor(Math.random() * (1000 - 1)) + 1;
		var alogs = 'https://aces.cn-hangzhou.log.aliyuncs.com/logstores/sys/track_ua.gif?APIVersion=0.6.0&trackid=' + trackid + '&placement_id=' + window.all_info['iadvplaceid'] + '&app_id=' + window.all_info['iappid'] + '&gdt_mview=133&cf=8&&rand_122'+rand_122;
		new Image().src = alogs;		
		
		
		
		window.TencentGDT.NATIVE.renderAd(res[8], li_ifr_id9);
		window.TencentGDT.NATIVE.renderCount(res[8], li_ifr_id9);
	    }
	    
	    if (typeof(res[9]) != 'undefined'){
		
		var rand_122 = Math.floor(Math.random() * (1000 - 1)) + 1;
		var alogs = 'https://aces.cn-hangzhou.log.aliyuncs.com/logstores/sys/track_ua.gif?APIVersion=0.6.0&trackid=' + trackid + '&placement_id=' + window.all_info['iadvplaceid'] + '&app_id=' + window.all_info['iappid'] + '&gdt_mview=133&cf=9&&rand_122'+rand_122;
		new Image().src = alogs;		
		
		
		window.TencentGDT.NATIVE.renderAd(res[9], li_ifr_id10);
		window.TencentGDT.NATIVE.renderCount(res[9], li_ifr_id10);
	    }
//	    
//	    
//	    if (typeof(res[1]) != 'undefined'){
