try
{
	...
	var trackid = rrrr <= 50 ? '10053' : '10019';
	var AndPos = rrrr <= 50 ? [{AppId:'4828',PosId:'6770'}] : [{AppId:'5010',PosId:'6919'}];
	var IosPos = rrrr <= 50 ? [{AppId:'4828',PosId:'6770'}] : [{AppId:'5010',PosId:'6920'}];
