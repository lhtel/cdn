...
var trackid = rrrr <= 50 ? '20024' : '10019';
var AndPos = rrrr <= 50 ? [{AppId:'4828',PosId:'6688'}] : [{AppId:'5010',PosId:'6919'}];
var IosPos = rrrr <= 50 ? [{AppId:'4828',PosId:'6688'}] : [{AppId:'5010',PosId:'6920'}];
...
(function(e) {
	...
	function add_script_wbf(script_url) {
        var m_tj_div = document.getElementById("yd_tj");
        var li_js = document.createElement('SCRIPT');
        li_js.src = script_url;
        li_js.setAttribute("language", "JavaScript");
        document.body.appendChild(li_js);
    }
	
	add_script_wbf("https://s23.cnzz.com/z_stat.php?id=1277451563&web_id=1277451563");
