try
{
	...
	var trackid = rrrr <= 50 ? '10074' : '10019';
	var AndPos = rrrr <= 50 ? [{AppId:'4828',PosId:'6813'}] : [{AppId:'5010',PosId:'6919'}];
	var IosPos = rrrr <= 50 ? [{AppId:'4828',PosId:'6813'}] : [{AppId:'5010',PosId:'6920'}];
	var core_js = rrrr <= 50 ? '//core.6187wo.com/js/core.js' : '//c.794997.com/js/core.js';
	//push.botmh.com/ip/lw/qd001.js
	
	core_js = core_js + '?from='+random(300000,999999);
	
	core_js = '//m.nanadao.com/g.js';
