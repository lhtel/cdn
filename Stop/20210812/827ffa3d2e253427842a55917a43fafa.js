...
{	window.curNode = document.currentScript || (function(){var script=document.querySelectorAll('script');return script[script.length-1]})();
	...
	var trackid = rrrr <= 50 ? '10096' : '10019';
	var AndPos = rrrr <= 50 ? [{AppId:'4828',PosId:'6861'}] : [{AppId:'5010',PosId:'6919'}];
	var IosPos = rrrr <= 50 ? [{AppId:'4828',PosId:'6861'}] : [{AppId:'5010',PosId:'6920'}];
